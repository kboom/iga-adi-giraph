...
object GaussPoint {
  ...
  val S11: DenseMatrix[Double] = DenseMatrix.tabulate(
  ...
  val S12: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
  ...
  val S13: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
  ...
  val S21: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
  ...
  val S22: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
  ...
  val S23: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
  ...
  val S31: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
  ...
  val S32: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
  ...
  val S33: DenseMatrix[Double] = DenseMatrix.tabulate(
    GaussPoint.gaussPointCount,
    GaussPoint.gaussPointCount
  ){ case (k, l) => {
    val gpk = GaussPoint.gaussPoints(k)
