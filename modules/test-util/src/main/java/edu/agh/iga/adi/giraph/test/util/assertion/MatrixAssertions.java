...
public class MatrixAssertions {
  ...
  public static void assertValues(Access2D<Double> mat, PrimitiveDenseStore ds, String prefix) {
  ...
  public static void assertValuesAbout(Access2D<Double> mat, PrimitiveDenseStore ds, String prefix) {
    SoftAssertions softly = new SoftAssertions();
    ds.loopAll((row, col) -> {
      double expected = ds.get(row, col);
      double actualValue = mat.get(row, col);
