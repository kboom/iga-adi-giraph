...
class IgaOperationFactoryTest {
  ...
  private static final TestOperationFactory T24OF = new TestOperationFactory(Problems.TREE_24);

  @Test
  void canGenerateTopTriangle() {
    assertThat(newArrayList(operationsFor(TREE_12, vertexOf(TREE_12, 1), 1)))
  ...
  void canGenerateBottomTriangle() {
    assertThat(newArrayList(operationsFor(TREE_12, vertexOf(TREE_12, 4), 1)))
        .containsExactlyInAnyOrder(
  ...
  void canGenerateGraphFor24Elements() {
    assertThat(newArrayList(operationsFor(Problems.TREE_24)))
        .containsExactlyInAnyOrder(
