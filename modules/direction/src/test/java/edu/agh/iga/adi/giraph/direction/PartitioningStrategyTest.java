...
final class PartitioningStrategyTest {
  ...
  @Test
  void partitionTree6144ForRootAnd64PartitionsShouldBe1() {
  ...
  @Test
  void partitionTree6144For63And64PartitionsShouldBe63For1Worker() {
    assertThat(partitioningStrategy(TREE_6144, 64, 1).partitionFor(63))
            .isEqualTo(63);
  }

  @Test
  void partitionTree6144For63And64PartitionsShouldBe31For2Workers() {
    assertThat(partitioningStrategy(TREE_6144, 64, 2).partitionFor(63))
            .isEqualTo(31);
  }

  @Test
  void tipForTree12And1PartitionIs3() {
    assertThat(partitioningStrategy(TREE_12, 1, 1).getTipHeight()).isEqualTo(0);
  }

  @Test
  void tipForTree6144And1PartitionIs12() {
    assertThat(partitioningStrategy(TREE_6144, 1, 1).getTipHeight()).isEqualTo(0);
  }

  @Test
  void tipForTree12And2PartitionIs1() {
    assertThat(partitioningStrategy(TREE_12, 2, 1).getTipHeight()).isEqualTo(1);
    assertThat(partitioningStrategy(TREE_12, 2, 1).getBottomHeight()).isEqualTo(2);
  }

  @Test
  void tipForTree12And4PartitionIs2() {
    assertThat(partitioningStrategy(TREE_12, 4, 1).getTipHeight()).isEqualTo(2);
    assertThat(partitioningStrategy(TREE_12, 4, 1).getBottomHeight()).isEqualTo(1);
  }

  @Test
  void tipForTree12And8PartitionIs3() {
    assertThat(partitioningStrategy(TREE_12, 8, 1).getTipHeight()).isEqualTo(2);
    assertThat(partitioningStrategy(TREE_12, 8, 1).getBottomHeight()).isEqualTo(1);
  }
