...
plot \
    "weak-scalability.csv" using 3:($8==590000?$22:1/0):xtic($3) with points ls 1 title tit(590000), \
    o1(x) with lines lc rgb 'red' lw 2 title o1title, \
    "weak-scalability.csv" using 3:($8==147000?$22:1/0):xtic($3) with points ls 2 title tit(147000), \
