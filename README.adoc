...
|_giraph.nettyRequestEncoderBufferSize_| 327680|the number of threads to use for output split|high reduction of computation times for larger problems
|_giraph.clientReceiveBufferSize_| 327680|the number of threads to use for output split|high reduction of computation times for larger problems
|_giraph.clientSendBufferSize_| 5242880|the number of threads to use for output split|high reduction of computation times for larger problems
|===
