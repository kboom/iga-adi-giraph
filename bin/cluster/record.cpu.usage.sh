...
LOG_TOP_PROCESS_FILE="$LOGS_DIR/$RUN-top-proc.txt"
LOG_TOP_CPUS_FILE="$LOGS_DIR/$RUN-top-cpus.txt"
...
TOP_CPUS_HEADER="echo 'cpu,us,sy,ni,id,wa,hi,si,st'"
...
TOP_CPUS_FILTER="grep %Cpu | sed 's/[%A-Za-z ]\+//g' | sed 's/:/,/g'"
