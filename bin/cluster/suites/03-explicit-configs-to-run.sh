...
do
  execute 1536 2 32 "$run"
  execute 3072 2 32 "$run"
  execute 6144 2 32 "$run"
#  execute 1536 1 64 "$run"
#  execute 3072 1 64 "$run"
#  execute 6144 1 64 "$run"
#  execute 1536 2 16 "$run"
#  execute 1536 1 16 "$run"
#  execute 3072 2 16 "$run"
#  execute 3072 1 16 "$run"
#  execute 6144 2 16 "$run"
#  execute 6144 1 16 "$run"
